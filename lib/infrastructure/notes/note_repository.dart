...
import 'package:resolly/infrastructure/core/firestore_helpers.dart';
import 'package:resolly/infrastructure/notes/note_dtos.dart';
  ...
  Stream<Either<NoteFailure, KtList<Note>>> watchAll() async* {
    ...
    yield* userDoc.noteCollection
      ...
      return
          ...
          //     ? left<NoteFailure, KtList<Note>>(const NoteFailure.unableToUpdate())
          //     :
          right<NoteFailure, KtList<Note>>(snapshot.docs
